.class public Lcom/synconset/CordovaHttpGet;
.super Lcom/synconset/CordovaHttp;
.source "CordovaHttpGet.java"
...
.method public run()V
    ...
    .line 25
    :try_start_0
    invoke-virtual {p0}, Lcom/synconset/CordovaHttpGet;->getUrlString()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {p0}, Lcom/synconset/CordovaHttpGet;->getParams()Ljava/util/Map;

    move-result-object v6

    const/4 v7, 0x1

    invoke-static {v5, v6, v7}, Lcom/synconset/HttpRequest;->get(Ljava/lang/CharSequence;Ljava/util/Map;Z)Lcom/synconset/HttpRequest;

    move-result-object v3

    .line 26
    .local v3, "request":Lcom/synconset/HttpRequest;
    invoke-virtual {p0, v3}, Lcom/synconset/CordovaHttpGet;->setupSecurity(Lcom/synconset/HttpRequest;)Lcom/synconset/HttpRequest;
    ...
    .line 28
    invoke-virtual {p0}, Lcom/synconset/CordovaHttpGet;->getHeaders()Ljava/util/Map;
    ...
    .line 35
    invoke-virtual {p0}, Lcom/synconset/CordovaHttpGet;->getCallbackContext()Lorg/apache/cordova/CallbackContext;
    ...
    invoke-virtual {p0, v5}, Lcom/synconset/CordovaHttpGet;->respondWithError(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v5, v6}, Lcom/synconset/CordovaHttpGet;->respondWithError(ILjava/lang/String;)V
