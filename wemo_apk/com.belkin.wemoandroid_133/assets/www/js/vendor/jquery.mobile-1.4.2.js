...
// Auto self-init widgets
        $.mobile.degradeInputsWithin = function( target ) {
            ...
            target.find( "input" ).not( $.mobile.page.prototype.keepNativeSelector() ).each(function() {
            	...
            	console.log("degradeInputsWithin : "+e.message);
            	if(e.message=="Object #<Object> has no method 'each'")
            	{$.mobile.degradeInputsWithin(forcatchTarget);}
            }
    ...
    (function( $, undefined ) {
        ...
        $.widget( "mobile.toolbar", {
            ...
            _addHeadingClasses: function() {
            	...
            	console.log("JQuery error for lower end processors :: "+e.message)
            }
            }
        });
