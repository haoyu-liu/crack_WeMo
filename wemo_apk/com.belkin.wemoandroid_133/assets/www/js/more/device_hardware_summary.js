...
var View = function () {
    var TAG = "device_hardware_info.js: ",
        model = JSON.parse(window.sessionStorage.getItem('deviceInfoModel')),
        deviceSummaryTemplate = _.template($('.device-summary-template').html()),
        View = {
            initialize: function () {
            ...
            render: function () {
                var $summaryContainer = $('.device-summary'),
                    html = deviceSummaryTemplate(model);
