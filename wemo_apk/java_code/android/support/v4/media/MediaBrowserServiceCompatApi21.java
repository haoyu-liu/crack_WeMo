    ...
    implements MediaBrowserServiceCompatApi21.ServiceCallbacks
  {
      ...
      throws RemoteException
    {
      ...
      if (Build.VERSION.SDK_INT > 23)
      {
        ...
        for (localObject = null;; localObject = ParceledListSliceAdapterApi21.newInstance(localArrayList))
        {
          this.mCallbacks.onLoadChildren(paramString, localObject);
          return;
        }
      }
      if (localArrayList == null) {}
      for (Object localObject = sNullParceledListSliceObj;; localObject = ParceledListSliceAdapterApi21.newInstance(localArrayList)) {
        break;
      }
    }
  }
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/android/support/v4/media/MediaBrowserServiceCompatApi21.class
