    ...
    implements IInterface
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        {
          connect(str2, localBundle, IMediaBrowserServiceCallbacksAdapterApi21.Stub.asInterface(paramParcel1.readStrongBinder()));
          return true;
        }
      case 2: 
        paramParcel1.enforceInterface("android.service.media.IMediaBrowserService");
      ...
      if (paramParcel1.readInt() != 0) {}
      for (ResultReceiver localResultReceiver = (ResultReceiver)ResultReceiver.CREATOR.createFromParcel(paramParcel1);; localResultReceiver = null)
      {
        getMediaItem(str1, localResultReceiver);
        return true;
      }
    }
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/android/support/v4/media/IMediaBrowserServiceAdapterApi21.class
