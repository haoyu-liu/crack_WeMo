...
public final class MediaBrowserCompat
{
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public void onConnected()
    {
      ...
      this.mServiceBinderWrapper = new MediaBrowserCompat.ServiceBinderWrapper(localIBinder);
    ...
    public void onLoadChildren(Messenger paramMessenger, String paramString, List paramList, @NonNull Bundle paramBundle)
    {
      ...
      localSubscription.getCallback(paramBundle).onChildrenLoaded(paramString, paramList, paramBundle);
    }
    ...
    public void onServiceConnected(Messenger paramMessenger, String paramString, MediaSessionCompat.Token paramToken, Bundle paramBundle)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (i < localList1.size())
        {
          ...
          MediaBrowserCompatApi21.subscribe(this.mBrowserObj, str, MediaBrowserCompat.SubscriptionCallbackApi21.access$1800((MediaBrowserCompat.SubscriptionCallbackApi21)localList2.get(i)));
        }
        for (;;)
        {
          i++;
          ...
          {
            label131:
            this.mServiceBinderWrapper.addSubscription(str, (Bundle)localList1.get(i), this.mCallbacksMessenger);
          }
          catch (RemoteException localRemoteException)
          {
    ...
    public void subscribe(@NonNull String paramString, Bundle paramBundle, @NonNull MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      localSubscription.setCallbackForOptions(localSubscriptionCallbackApi21, paramBundle);
      if (MediaBrowserCompatApi21.isConnected(this.mBrowserObj))
      {
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
  {
    ...
    public void onServiceConnected(Messenger paramMessenger, String paramString, MediaSessionCompat.Token paramToken, Bundle paramBundle)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          Iterator localIterator1 = this.mSubscriptions.entrySet().iterator();
          while (localIterator1.hasNext())
          {
            Map.Entry localEntry = (Map.Entry)localIterator1.next();
            String str = (String)localEntry.getKey();
            Iterator localIterator2 = ((MediaBrowserCompat.Subscription)localEntry.getValue()).getOptionsList().iterator();
            while (localIterator2.hasNext())
            {
              Bundle localBundle = (Bundle)localIterator2.next();
              this.mServiceBinderWrapper.addSubscription(str, localBundle, this.mCallbacksMessenger);
            }
          }
          return;
        }
    ...
    public void subscribe(@NonNull String paramString, Bundle paramBundle, @NonNull MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      localSubscription.setCallbackForOptions(paramSubscriptionCallback, paramBundle);
      if (this.mState == 2) {}
      try
      {
        this.mServiceBinderWrapper.addSubscription(paramString, paramBundle, this.mCallbacksMessenger);
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/android/support/v4/media/MediaBrowserCompat.class
