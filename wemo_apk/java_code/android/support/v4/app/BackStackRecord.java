  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private void ensureFragmentsAreInitialized(SparseArray<Fragment> paramSparseArray)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      Fragment localFragment = (Fragment)paramSparseArray.valueAt(j);
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
