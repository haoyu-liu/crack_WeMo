      ...
      for (int j = 0;; j++)
      {
        ...
        else
        {
          if (localObject != null)
          {
            ...
            HttpEntity localHttpEntity = (HttpEntity)((Field)localObject).get(paramHttpEntity);
            if (localHttpEntity != null) {
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/com/loopj/android/http/AsyncHttpClient.class
