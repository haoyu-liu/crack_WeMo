...
public class RequestParams
{
    ...
    throws IOException
  {
    ...
    while (localIterator4.hasNext())
    {
      ...
      localSimpleMultipartEntity.addPart((String)localEntry1.getKey(), localFileWrapper.file, localFileWrapper.contentType);
    }
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/com/loopj/android/http/RequestParams.class
