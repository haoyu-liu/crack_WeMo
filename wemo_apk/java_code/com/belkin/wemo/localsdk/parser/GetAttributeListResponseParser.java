  ...
  extends DefaultHandler
{
  ...
  public JSONObject parseGetAttributeListResponse(String paramString)
  {
    if (paramString != null) {}
    try
    {
    ...
    catch (SAXException localSAXException)
    {
      for (;;)
      {
        Log.e(TAG, "Exceptio" + localSAXException.toString());
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/com/belkin/wemo/localsdk/parser/GetAttributeListResponseParser.class
