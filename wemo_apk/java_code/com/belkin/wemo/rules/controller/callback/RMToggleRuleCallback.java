...
public class RMToggleRuleCallback
  extends RMAbstractRulesCallback
  implements RMToggleRuleErrorCallback, RMToggleRuleSuccessCallback
{
  private int ruleId;
  
  public RMToggleRuleCallback(CallbackContext paramCallbackContext, int paramInt)
  {
  ...
  public void onRuleToggled(RMRule paramRMRule)
  {
    LogUtils.debugLog(this.TAG, "Store Rules: Rule state toggled successfully. RuleId: " + paramRMRule.getRuleId());
...
/* Location:              /root/Documents/wemo_apk/classes-dex2jar.jar!/com/belkin/wemo/rules/controller/callback/RMToggleRuleCallback.class
